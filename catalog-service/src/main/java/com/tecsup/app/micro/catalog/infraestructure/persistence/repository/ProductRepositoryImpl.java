...
import com.tecsup.app.micro.catalog.infraestructure.persistence.entity.ProductEntity;
import com.tecsup.app.micro.catalog.infraestructure.persistence.mapper.ProductPersistenceMapper;
...
public class ProductRepositoryImpl implements ProductRepository {
    ...
    public List<Product> findByCategoryId(Long categoryId) {
        log.debug("Finding products by category: {}", categoryId.toString());
        return mapper.toDomainList(jpaProductRepository.findByCategoryId(categoryId));
    }

    @Override
    public List<Product> findByRestaurantId(Long restaurantId) {
        return mapper.toDomainList(jpaProductRepository.findByRestaurantId(restaurantId));
    }
