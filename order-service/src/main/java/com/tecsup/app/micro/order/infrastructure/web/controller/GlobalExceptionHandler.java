...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleProductNotFoundException(OrderNotFoundException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidProductDataException(InvalidOrderDataException ex) {
